...
class UpdateASAForm extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  final bool isUpdate;

  UpdateASAForm({this.initialData, this.isUpdate = false});

  @override
  _UpdateASAFormState createState() => _UpdateASAFormState();
}

class _UpdateASAFormState extends State<UpdateASAForm> {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        String endpoint = widget.isUpdate
            ? "http://13.232.9.135:3000/api/updateASA"
            : "http://13.232.9.135:3000/api/createASA";
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(widget.isUpdate ? 'Update ASA' : 'Add ASA'),
        ),
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    widget.isUpdate ? 'Update ASA Details' : 'Add ASA Details',
                    style: TextStyle(
                      fontSize: 24,
                  ...
                  ...[ 
                    ...
                    {'label': 'ASA Name', 'field': 'ASA_Name'},
                    {'label': 'Phase', 'field': 'Phase'},
                    {'label': 'RC', 'field': 'RC'},
                    {'label': 'Willing to join CUG', 'field': 'Willing_to_join_CUG'},
                    {'label': 'ASA Mail ID', 'field': 'ASA_Mail_id', 'readOnly': widget.isUpdate},
